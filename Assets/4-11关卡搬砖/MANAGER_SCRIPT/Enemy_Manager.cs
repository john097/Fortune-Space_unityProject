...
public class Enemy_Manager : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        if (!flowchart.GetBooleanVariable("IS_TALKING"))
        {
            ...
            if (B_Manager.startspawn == true && Monster_CurrentWaves < B_Manager.Monster_Waves && ME.this_room_type == 3 && B_Manager.Current_State == 1)//开始守护据点房刷怪模式（需要调整逻辑
            {
            ...
            if (B_Manager.startspawn == true && ME.this_room_type == 3 && B_Manager.Dead_Room_Battle && B_Manager.Current_State == 2)//开始死斗房刷怪模式（需要调整逻辑
            {
            ...
            if (B_Manager.startspawn == true && ME.this_room_type == 3 && B_Manager.BOSS_Battle && B_Manager.Current_State == 3)//开始BOSS房刷怪模式（需要调整逻辑
            {
                B_Manager.START_WAVE();
